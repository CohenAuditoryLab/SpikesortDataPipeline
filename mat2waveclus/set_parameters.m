...
par.to_plot_std = 2; %1;                 % # of std from mean to plot.


% SPC PARAMETERS
par.mintemp = 0.00;                  % minimum temperature for SPC
par.maxtemp = 5.0; %0.201;                 % maximum temperature for SPC
...
par.min_clus = 150; %60;                   % minimum size of a cluster (default 60)
par.min_clus_rel = 0.005;            % minimum cluster size, relative to the total nr. of spikes (only for batch scripts).
par.max_clus = 64; %13;                   % maximum number of clusters allowed (default 13)
