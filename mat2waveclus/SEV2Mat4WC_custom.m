...
fileNames = {'20180807_ABBA_d01', '20180807_Ripple2_d01', '20180807_Vocalization_d01'};
currentPath = pwd;
for f =1:5
    mkdir(['H:\Domo\' fileNames{f}]);
    ...
    for i=1:16
        ...
        data = SEV2mat(['D:\SpikeSortingPipeline\Tanks\Domo\Domo\' fileNames{f}],'CHANNEL',i);
        sr=data.Wav1.fs;
        data= data.Wav1.data;
