...
%             cluster_class = do_clustering_single(filename,min_spikes4SPC, par_file, par_input,fnum);
...
function classes = do_clustering_single(filename,min_spikes4SPC, par_file, par_input,fnum)
